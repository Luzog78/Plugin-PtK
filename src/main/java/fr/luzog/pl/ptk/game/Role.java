...
public enum Role {
    ...
    Role(String name, float healthModifier, int armorLimit, List<EffectItem> effects,
    ...
    Role(String name, String description, float healthModifier, int armorLimit, List<EffectItem> effects,
         List<KitItem> kit, Map<Enchantment, Integer> enchantLimit) {
        this.name = name;
        this.description = description;
        this.healthModifier = healthModifier;
